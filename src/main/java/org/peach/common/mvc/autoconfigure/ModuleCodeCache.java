 ...
 * {@link #setCachedModule(String)} 写入；{@link org.peach.common.mvc.result.ApiResult}、
 * {@link org.peach.common.mvc.exception.ErrorResult} 通过 {@link #get()} 读取以拼接业务 {@code code}。
 *
 * @author leiyangjun
 */
