 ...
 * {@code setConnectTimeout}，建立连接超时由池中 {@link org.apache.hc.client5.http.impl.classic.CloseableHttpClient} 的默认
 * {@link org.apache.hc.client5.http.config.RequestConfig} 控制，见 {@link PeachHttpPoolProperties}），底层仍共享本池。
 * </p>
 *
 * @author leiyangjun
 */
...
public class PeachHttpClientPoolAutoConfiguration {
	...
	public CloseableHttpClient peachPooledHttpClient(PeachHttpPoolProperties props) {
		...
		connectionManager.setMaxTotal(props.getMaxTotal());
